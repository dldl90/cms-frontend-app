...
import { FlexibleCampaign } from './FlexibleCampaign';
import { FlexibleTemplate, NotFound } from '../../../templates';

describe('Flexible Campaign Container', () => {
  describe('when rendering a Flexible Campaign page without successfully loaded content', () => {
    let component;
    ...
    const mockProps = {
      ...
      page: null,
      error: null,
      location: { pathname: '/campaign/flexi' },
      route: { contentType: 'flexible_campaign_template' },
    };

    component = shallow(<FlexibleCampaign {...mockProps} />);
    ...
    it('should call loadData with correct args to fetch data', () => {
      ...
      component = shallow(<FlexibleCampaign {...newProps} />);
  ...
  describe('When rendering a Flexible Campaign page and have successfully loaded content', () => {
    ...
    const component = shallow(<FlexibleCampaign {...mockProps} />);
